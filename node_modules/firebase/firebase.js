...
"invalid-action-code":"The action code is invalid. This can happen if the code is malformed, expired, or has already been used.","wrong-password":"The password is invalid or the user does not have a password.","missing--start":"An internal error has occurred.","auth-domain-config-required":"Be sure to include authDomain when calling firebase.initializeApp(), by following the instructions in the Firebase console.","app-deleted":"This instance of FirebaseApp has been deleted.","account-exists-with-different-credential":"An account already exists with the same email address but different sign-in credentials. Sign in using a provider associated with this email address.",
...
var Wg=function(a){var b=new Tg;b.U.where=document.body;b.U.url=a.$e;b.U.messageHandlersFilter=xf("gapi.s.CROSS_ORIGIN_IFRAMES_FILTER");b.U.attributes=b.U.attributes||{};(new Sg(b.U.attributes)).Gd({position:"absolute",top:"-100px",width:"1px",height:"1px"});b.U.dontclear=!0;return b},Ug=function(a){return Xg().then(function(){return new H(function(b,c){xf("gapi.s.getContext")().open(Wg(a).value(),function(d){a.Cc=d;a.Cc.restyle({setHideOnLeave:!1});var e=setTimeout(function(){c(Error("Network Error"))},
5E3),f=function(){clearTimeout(e);b()};d.ping(f).then(f,function(){c(Error("Network Error"))})})})})},Yg=function(a,b){a.vd.then(function(){a.Cc.register("authEvent",b,xf("gapi.s.CROSS_ORIGIN_IFRAMES_FILTER"))})},Xg=function(){return new H(function(a,b){var c=function(){Ff();xf("gapi.load")("gapi.s",{callback:a,ontimeout:function(){Ff();b(Error("Network Error"))},timeout:3E3})};if(xf("gapi.s.Iframe"))a();else if(xf("gapi.load"))c();else{var d="__fcb"+Math.floor(1E6*Math.random()).toString();
l[d]=function(){xf("gapi.load")?c():b(Error("Network Error"))};I(Qd("/js/api.js?onload="+d)).l(function(){b(Error("Network Error"))})}})};var Zg=function(a,b,c){this.C=a;this.m=b;this.F=c;this.La=null;this.u=ef(this.C,"/__/auth/");O(this.u,"apiKey",this.m);O(this.u,"appName",this.F)};Zg.prototype.setVersion=function(a){this.La=a;return this};Zg.prototype.toString=function(){this.La?O(this.u,"v",this.La):cf(this.u,"v");return this.u.toString()};
...
function eb(){var a=n.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&-1==v.indexOf("Presto")&&(a=function(){var a=document.createElement("");a.style.display="none";a.src="";document.documentElement.appendChild(a);var b=a.contentWindow,a=b.document;a.open();a.write("");a.close();var c="callImmediate"+Math.random(),d="file:"==b.location.protocol?"*":b.location.protocol+"//"+b.location.host,a=r(function(a){if(("*"==d||a.origin==
...
Qe.prototype.start=function(){var a=this.Wa,b=this.mf;a.fg=this.id;a.gg=b;for(a.Ud=!0;We(a););a=this.id;b=this.mf;this.gc=document.createElement("");var c={dframe:"t"};c.id=a;c.pw=b;this.gc.src=this.Yc(c);this.gc.style.display="none";document.body.appendChild(this.gc)};
...
function Te(a,b,c,d){this.Yc=d;this.kb=c;this.ve=new Oe;this.Qc=[];this.$d=Math.floor(1E8*Math.random());this.Kd=!0;this.Qd=Rc();window["pLPCommand"+this.Qd]=a;window["pRTLPCB"+this.Qd]=b;a=document.createElement("");a.style.display="none";if(document.body){document.body.appendChild(a);try{a.contentWindow.document||E("No IE domain setting required")}catch(e){a.src="javascript:void((function(){document.open();document.domain='"+document.domain+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";
